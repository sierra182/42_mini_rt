...
void	fill_struct_sp(t_data *data, double tab[])
{
	...
	data->spheres[i].square_radius = data->spheres[i].radius * data->spheres[i].radius;
...
void	fill_struct_cy(t_data *data, double tab[])
{
	...
	data->cylinders[i].square_radius = data->cylinders[i].radius * data->cylinders[i].radius;
